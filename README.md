...
Далее нужно будет ввести ФИО ученика(можно указывать не полностью, но если будет несколько людей подходящих по такому же имени, то появится соответствующее сообщение), а после этого предмет по которому нужно будет добавить хороший комментарий от учителя
```
Введите имя ученика: ФИО
Введите название предмета: Название предмета
```
